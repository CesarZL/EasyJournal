<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
            <p>
                {{ __('Cuando se habilita la autenticación de dos factores, se le solicitará un token seguro y aleatorio durante la autenticación. Puede obtener este token desde la aplicación Google Authenticator en su teléfono.') }}
