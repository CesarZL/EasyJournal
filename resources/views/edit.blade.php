...
<button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
 ...
 <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
   <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
       <ul class="space-y-2">
           <li>
            <a type="button" href="{{route('home')}}" class="mb-5 flex items-center p-2 text-base font-normal rounded-lg dark:text-white hover:bg-purple-700 dark:hover:bg-gray-700 group bg-purple-200 text-purple-800 hover:text-purple-100 cursor-pointer">    
                <span class="ml-3 font-bold text-sm">NOMBRE DEL ARTÍCULO</span>
            </a>
           </li>
           <li>
   ...
   <div class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20 border-r border-gray-200 dark:border-gray-700">
       <a href="{{route('home')}}" data-tooltip-target="tooltip-home" class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:hover:text-white dark:text-gray-400 hover:text-gray-900 hover:bg-purple-100 dark:hover:bg-gray-600">
        ...
        <div id="tooltip-home" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip">
            Volver a mis artículos
              <div class="tooltip-arrow" data-popper-arrow></div>
          </div>
       <a href="#" data-tooltip-target="tooltip-settings" class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:hover:text-white dark:text-gray-400 hover:text-gray-900 hover:bg-purple-100 dark:hover:bg-gray-600">
       ...
       <button type="button" data-dropdown-toggle="profile-dropdown" class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:hover:text-white dark:text-gray-400 hover:text-gray-900 hover:bg-purple-100 dark:hover:bg-gray-600">
      ...
      <path d="M106.81863443903,481.4 a205,205 1 0,1 386.36273112194,0" stroke-linecap="butt" />
       ...
       <!-- Dropdown -->
       <div class="hidden z-50 my-4 text-base list-none bg-gray-100 divide-y divide-gray-100 shadow dark:bg-gray-700 rounded-lg" id="profile-dropdown">
        <ul class="py-1" role="none">
          {{-- <li>
            <a href="#" class="block py-2 mx-1 px-2 text-sm text-gray-700 hover:bg-green-200 dark:hover:text-white dark:text-gray-300 dark:hover:bg-gray-600 rounded-md" role="menuitem">
          ...
          <li>
            <a class="block py-2 mx-1 px-2 text-sm text-gray-700 hover:bg-red-200 dark:hover:text-white dark:text-gray-300 dark:hover:bg-gray-600 rounded-md" role="menuitem" href="{{ route('logout') }}"
