    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
                ...
                <form id="save-form" class="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6" method="POST" action="{{ route('home.store') }}">
                    @csrf
                    <div class="col-span-3">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre del artículo</label>
                        <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500" required="" placeholder="Informe de avance">
                    </div>
            ...
            <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                ...
                <button data-modal-hide="static-modal" type="button" class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800" onclick="event.preventDefault();
                    ...
                    @foreach ($articles as $article)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <a type="button" href="/edit" class="hover:underline">{{ $article->name }}</a>
                            </th>
                            <td class="px-6 py-4">
                                {{ $article->user->name }}
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <form method="POST" action="{{ route('home.destroy', $article->id) }}" id="destroy-form">
                                    @csrf
                                </form>
