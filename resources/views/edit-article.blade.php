<x-edit-layout>
    ...
    <div class="flex justify-between items-center py-3 mb-2">
        ...
        <div class="flex">
            <a id="save-data" class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-500 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600" onclick="event.preventDefault(); document.getElementById('form-update').submit()">
    ...
    <div class="flex flex-col xl:flex-row ">
        ...
        <div class="flex-1">
            <div class="rounded-lg bg-red-50 dark:bg-gray-700 h-screen">
                 <embed class="rounded-lg" id="pdf-embed" type="application/pdf" width="100%" height="100%" src="{{ asset('templates_public/' . $article->id . '/article_test.pdf') }}">
            </div>
        </div>
    </div>
