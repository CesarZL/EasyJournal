...
<button {{ $attributes->merge(['type' => 'button', 'class' => 'text-primary-700 border border-2 border-primary-700 hover:text-white hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-primary-300 dark:border-primary-600 dark:hover:text-white dark:hover:bg-primary-600 dark:focus:ring-primary-800']) }}>
    {{ $slot }}
</button>
